...
#[Fillable(['name', 'email', 'password', 'role', 'allowed_modules', 'basic_salary', 'total_salary', 'required_days', 'overtime_rate', 'is_archived', 'contact_number', 'attendance_allowance', 'performance_allowance'])]
